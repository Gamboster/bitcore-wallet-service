...
WalletService.prototype._decorateTxHistory = function(txs, addresses, proposals, notes) {
...
WalletService.prototype.getTxHistory = function(opts, cb) {
  ...
  self.storage.fetchAddresses(self.walletId, function(err, addresses) {
    ...
    async.waterfall([
      ...
      var finalTxs = self._decorateTxHistory(res.txs.items, addresses, res.txps, res.notes);
...
WalletService.prototype.getTxHistory2 = function(opts, cb) {
  ...
  self._getActiveAddresses(function(err, addresses) {
    ...
    async.parallel([
      ...
      var finalTxs = self._decorateTxHistory(res[0].items, addresses, res[1], res[2]);
