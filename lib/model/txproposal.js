...
TxProposal.Types = {
  ...
  STANDARD: 'standard', // Replaces both SIMPE & MULTIPLEOUTPUTS
  EXTERNAL: 'external'
};
...
TxProposal.create = function(opts) {
  ...
  try {
    var addr = opts.toAddress || x.outputs[0].toAddress;
    x.network = Bitcore.Address(addr).toObject().network;
  } catch (ex) {}
  ...
  console.log('*** [txproposal.js ln113] x:', x); // TODO
